...
│   ├── rag.md                   ← RAG pipeline details
│   ├── security.md              ← Secure Store documentation
│   ├── testing.md               ← Testing Strategy
│   ├── conclusion.md            ← Conclusion & Future Scope
...
# Optional for production-grade PII encryption
PII_ENCRYPTION_KEY=your_32_byte_base64_or_64_char_hex
```

> **MongoDB Atlas Setup**: After connecting, create a **Vector Search index** named `vector_index_1` on the `policydocuments` collection with `numDimensions: 768` and `similarity: cosine`. See [models.md](./docs/models.md) for details.
...
|---|---|
| [app.md](./docs/app.md) | Next.js pages, routing, layout, and UI structure |
| [api.md](./docs/api.md) | All backend API route handlers with request/response flows |
| [lib.md](./docs/lib.md) | Server utilities: auth, DB, session, chat-memory, embeddings |
| [mastra.md](./docs/mastra.md) | AI agent layer overview and orchestration |
| [agents.md](./docs/agents.md) | Master agent configuration and tool wiring |
| [memory.md](./docs/memory.md) | Agent persistent memory using LibSQL threads |
| [prompts.md](./docs/prompts.md) | Stage-aware system prompt design and persona |
| [tools.md](./docs/tools.md) | All 7 agent-callable tools with input/output schemas |
| [models.md](./docs/models.md) | MongoDB Mongoose schemas (User, Loan, KYC, Credit, PolicyDocument) |
| [rag.md](./docs/rag.md) | RAG pipeline — PDF ingestion, vector embeddings, semantic search, policy Q&A |
| [security.md](./docs/security.md) | **Secure Store** — AES-256-GCM encryption for PII data (PAN/Aadhaar) |
| [secondperson.md](./docs/secondperson.md) | Returning user detection, session hydration, KYC skip, fast-path flow |
| [testing.md](./docs/testing.md) | **Testing Strategy** — Unit & Integration tests, tooling setup (Vitest) |
| [test.md](./docs/test.md) | **Test Fixtures & Scenarios** — Reference data and manual test paths |
| [conclusion.md](./docs/conclusion.md) | **Conclusion & Future Scope** — Project wrap-up and evolutionary roadmap |
