  ...
  return (
    <div className={`min-h-screen relative overflow-hidden selection:bg-teal-500/20 font-sans transition-colors duration-500 ${
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
        <div className={`absolute top-0 left-1/2 -translate-x-1/2 w-250 h-150 rounded-full blur-[120px] opacity-50 transition-colors duration-700 ${
          isDark ? "bg-blue-900/25" : "bg-blue-600/5"
        }`}></div>
        <div className={`absolute bottom-0 right-0 w-200 h-150 rounded-full blur-[100px] opacity-30 transition-colors duration-700 ${
          isDark ? "bg-teal-900/25" : "bg-teal-500/5"
        }`}></div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              ...
              <h1 className={`text-5xl md:text-7xl font-bold tracking-tight leading-[1.1] ${isDark ? "text-slate-100" : "text-slate-900"}`}>
                ...
                <span className="bg-linear-to-r from-blue-600 via-teal-500 to-blue-600 bg-clip-text text-transparent">In Minutes, Not Days</span>
              </h1>
              <p className={`text-lg max-w-2xl mx-auto lg:mx-0 ${isDark ? "text-slate-300" : "text-slate-600"}`}>
            ...
            <div className={`flex-1 w-full max-w-md rounded-3xl p-6 shadow-2xl border hidden lg:block ${
              isDark ? "bg-slate-900 border-slate-800" : "bg-white border-slate-100"
            }`}>
              <div className="space-y-4">
                <div className={`p-3 rounded-2xl rounded-bl-none text-sm max-w-[80%] ${
                  isDark ? "bg-slate-800 text-slate-200" : "bg-slate-100 text-slate-700"
                }`}>Hi! I need a personal loan of 5 Lakhs.</div>
                ...
                <div className={`h-24 border-2 border-dashed rounded-2xl flex items-center justify-center ${
      ...
      <section id="how-it-works" className={`py-20 transition-colors duration-500 ${isDark ? "bg-slate-900" : "bg-white"}`}>
        <div className="container mx-auto px-4">
          <h2 className={`text-3xl md:text-4xl font-bold text-center mb-16 ${isDark ? "text-slate-100" : "text-slate-900"}`}>How it Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="space-y-4">
              ...
              <h3 className={`text-xl font-bold ${isDark ? "text-slate-100" : "text-slate-900"}`}>Chat with Bot</h3>
              <p className={`${isDark ? "text-slate-300" : "text-slate-600"}`}>Provide basic details like PAN and Income to our smart AI assistant.</p>
            </div>
            <div className="space-y-4">
              ...
              <h3 className={`text-xl font-bold ${isDark ? "text-slate-100" : "text-slate-900"}`}>Get Match</h3>
              <p className={`${isDark ? "text-slate-300" : "text-slate-600"}`}>We instantly compare rates from 20+ banks to find the lowest EMI.</p>
            </div>
            <div className="space-y-4">
              ...
              <h3 className={`text-xl font-bold ${isDark ? "text-slate-100" : "text-slate-900"}`}>Instant Payout</h3>
              <p className={`${isDark ? "text-slate-300" : "text-slate-600"}`}>Once approved, the funds are transferred directly to your bank.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* NEW: Reviews Section */}
      <section id="reviews" className={`py-24 transition-colors duration-500 ${isDark ? "bg-slate-950" : "bg-slate-50"}`}>
        <div className="container mx-auto px-4 text-center">
          <h2 className={`text-3xl font-bold mb-16 ${isDark ? "text-slate-100" : "text-slate-900"}`}>Trusted by 10,000+ Users</h2>
